...
-- Must be VARCHAR(255) to match routers.router_id type (RMS device IDs like "6001744613")
ALTER TABLE ironwifi_guests ADD COLUMN IF NOT EXISTS router_id VARCHAR(255);
